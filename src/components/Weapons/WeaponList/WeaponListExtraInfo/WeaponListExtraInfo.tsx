...
export default function WeaponListExtraInfo(props: WeaponListExtraInfoProps) {
	...
	return (
		<div className='weapon-list-extra-info'>
			<button
				className='weapon-list-extra-info__link'
				onClick={() => setShowText(!showText)}
			>
				How is &apos;damage per second&apos; calculated?
			</button>
			{showText &&
				<>
					<div className='weapon-list-extra-info__paragraph'>
						<p>Damage per second is not the average damage dealt with body shots in 1 second.
						It&apos;s a realistic amount of damage you can deal in a 1 second slice.
						If a weapon can fire 1.5 shots a second, we only count 1 shot.
						That .5 of a shot can not be realistically dealt.</p>
					</div>
					<div className='weapon-list-extra-info__paragraph'>
